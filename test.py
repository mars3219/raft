...
def main(args):
    ...
    # 동영상 파일 열기
    cap = cv2.VideoCapture('/workspace/raft/falldown1.mp4')
    ret, frame1 = cap.read()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='/workspace/raft/models/raft-things.pth', help="restore checkpoint")
    parser.add_argument('--path', default='/workspace/raft/demo-frames', help="dataset for evaluation")
